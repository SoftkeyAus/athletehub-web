...
import Image01 from '../../assets/images/user-28-01.jpg';
import Image02 from '../../assets/images/user-28-02.jpg';
import Image03 from '../../assets/images/user-28-03.jpg';
import Image04 from '../../assets/images/user-28-04.jpg';
import Image05 from '../../assets/images/user-28-05.jpg';
import Image06 from '../../assets/images/user-28-06.jpg';
import Image07 from '../../assets/images/user-28-07.jpg';
import Image09 from '../../assets/images/user-28-09.jpg';
import Image11 from '../../assets/images/user-28-11.jpg';
            ...
            <tbody className="text-sm divide-y divide-slate-100 dark:divide-slate-700">
              ...
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="flex shrink-0 -space-x-3 -ml-px">
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={Image07} width="28" height="28" alt="User 07" />
                    </a>
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={Image04} width="28" height="28" alt="User 04" />
                    </a>
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={Image11} width="28" height="28" alt="User 11" />
                    </a>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
              ...
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="flex shrink-0 -space-x-3 -ml-px">
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={Image05} width="28" height="28" alt="User 05" />
                    </a>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
              ...
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="flex shrink-0 -space-x-3 -ml-px">
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={Image06} width="28" height="28" alt="User 06" />
                    </a>
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={Image11} width="28" height="28" alt="User 11" />
                    </a>
              ...
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="flex shrink-0 -space-x-3 -ml-px">
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={Image09} width="28" height="28" alt="User 09" />
                    </a>
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={Image01} width="28" height="28" alt="User 01" />
                    </a>
