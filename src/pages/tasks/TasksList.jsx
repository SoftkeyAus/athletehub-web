            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="sm:flex sm:justify-between sm:items-center mb-8">
                ...
                <div className="mb-4 sm:mb-0">
                  <h1 className="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">AthleteHub. Tasks ✨</h1>
                </div>
                ...
                <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-4">
                  ...
                  <div className="flex shrink-0 -space-x-3 -ml-px">
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-slate-100 dark:border-slate-900 box-content" src={UserImage08} width="32" height="32" alt="User 08" />
                    </a>
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-slate-100 dark:border-slate-900 box-content" src={UserImage07} width="32" height="32" alt="User 07" />
                    </a>
                    <a className="block" href="#0">
                      <img className="rounded-full border-2 border-slate-100 dark:border-slate-900 box-content" src={UserImage05} width="32" height="32" alt="User 05" />
                    </a>
                    ...
                    <div className="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4" draggable="true">
                      <div className="sm:flex sm:justify-between sm:items-start">
                        ...
                        <div className="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                          <div className="flex items-center">
                            ...
                            <button className="cursor-move mr-2">
                              ...
                              <svg className="w-3 h-3 fill-slate-300 dark:fill-slate-600" viexbox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex items-center justify-end space-x-3">
                          ...
                          <div className="flex shrink-0 -space-x-3 -ml-px">
                            <a className="block" href="#0">
                              <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage07} width="24" height="24" alt="User 07" />
                            </a>
                            <a className="block" href="#0">
                              <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage05} width="24" height="24" alt="User 05" />
                            </a>
                          </div>
                          {/* Like button */}
                    ...
                    <div className="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4" draggable="true">
                      <div className="sm:flex sm:justify-between sm:items-start">
                        ...
                        <div className="flex items-center justify-end space-x-3">
                          ...
                          <div className="flex shrink-0 -space-x-3 -ml-px">
                            <a className="block" href="#0">
                              <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage08} width="24" height="24" alt="User 08" />
                            </a>
                            <a className="block" href="#0">
                              <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={UserImage07} width="24" height="24" alt="User 07" />
                            </a>
