                          ...
                          <div className="flex flex-nowrap items-center space-x-2 mb-6">
                            ...
                            <div className="flex shrink-0 -space-x-3 -ml-px">
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User05} width="28" height="28" alt="User 05" />
                              </a>
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User08} width="28" height="28" alt="User 08" />
                              </a>
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User09} width="28" height="28" alt="User 09" />
                              </a>
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User06} width="28" height="28" alt="User 06" />
                              </a>
                            </div>
                      ...
                      <div className="grow pb-6 border-b border-slate-200 dark:border-slate-700">
                        <header>
                          <div className="flex flex-nowrap items-center space-x-2 mb-6">
                            ...
                            <div className="flex shrink-0 -space-x-3 -ml-px">
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User03} width="28" height="28" alt="User 03" />
                              </a>
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User05} width="28" height="28" alt="User 05" />
                              </a>
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User01} width="28" height="28" alt="User 01" />
                              </a>
                            </div>
                            <div className="text-slate-400 dark:text-slate-600">·</div>
                            <div>
                      ...
                      <div className="grow pb-6 border-b border-slate-200 dark:border-slate-700">
                        <header>
                          <div className="flex flex-nowrap items-center space-x-2 mb-6">
                            ...
                            <div className="flex shrink-0 -space-x-3 -ml-px">
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User06} width="28" height="28" alt="User 03" />
                              </a>
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User05} width="28" height="28" alt="User 05" />
                              </a>
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User09} width="28" height="28" alt="User 01" />
                              </a>
                            </div>
                            <div className="text-slate-400 dark:text-slate-600">·</div>
                            <div>
                        ...
                        <header>
                          <div className="flex flex-nowrap items-center space-x-2 mb-6">
                            ...
                            <div className="flex shrink-0 -space-x-3 -ml-px">
                              ...
                              <a className="block" href="#0">
                                <img className="rounded-full border-2 border-white dark:border-slate-800 box-content" src={User02} width="28" height="28" alt="User 02" />
                              </a>
                            </div>
                            <div className="text-slate-400 dark:text-slate-600">·</div>
                            <div>
